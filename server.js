// ===== BỘ NÃO CỦA HỆ THỐNG - PHIÊN BẢN HOÀN CHỈNH CUỐI CÙNG =====
// server.js
...
app.post('/api/bookings', async (req, res) => {
    try {
        ...
        // --- BẮT ĐẦU LOGIC KIỂM TRA TRÙNG LỊCH ---
        const doc = await accessSpreadsheet();
        const webBookingsSheet = doc.sheetsByTitle['WebBookings'];
        const walkinsSheet = doc.sheetsByTitle['Walkins'];
        ...
        for (const booking of staffBookingsOnDate) {
            ...
            // Điều kiện kiểm tra trùng lặp: (StartA < EndB) and (EndA > StartB)
        ...
        // --- KẾT THÚC LOGIC KIỂM TRA TRÙNG LỊCH ---
        
        // Nếu không trùng, tiến hành ghi vào sheet
